 ...
 */
final class Version20210422195513 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE website ADD author_id INT NOT NULL');
        $this->addSql('ALTER TABLE website ADD created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE website DROP author_id');
